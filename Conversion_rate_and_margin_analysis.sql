...
/*
1. First, I’d like to show our overall volume growth. So I will pull overall session and order volume, 
...
/*
3. I’d like to show how we’ve grown specific channels. So I'll pull a quarterly view of orders 
...
by quarter. Make a note of any periods where we made major improvements or optimizations.
*/
...
and margin by product, along with total sales and revenue. Seasonality can be seen from the result.
*/
...
/*
6. In order to dive deeper into the impact of introducing new products, I'll pull monthly sessions to 
...
So I'll pull sales data since then, and show how well each product cross-sells from one another.
*/
